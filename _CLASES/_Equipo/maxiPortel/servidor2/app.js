...
const nosotros = require('./router/nosotros');
...
app.use('/', home); //declaramos el link que usamos despues del dominio('/' es el index) y le pasamos la variable del require con la ruta del archivo modular
app.use('/nosotros', nosotros); //aca utilizamos /nosotros para empezar a desplegar mas link dentro de www.dominio.com/nosotros/nuevosEnlaces
